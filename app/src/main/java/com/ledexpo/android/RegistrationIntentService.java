...
public class RegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                String android_id = Settings.Secure.getString(RegistrationIntentService.this.getContentResolver(), Settings.Secure.ANDROID_ID);
                String searchUrl = Constants.push_Url + token + "&device_id=" + android_id + "&event_id=" + Constants.EVENT_ID;
